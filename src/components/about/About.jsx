         ...
         <div className='container'>
            ...
            <div className='row'>
               ...
               <div className='about-text'>
                  <p>
                     I am 23, ecuadorian fascinated by web technologies, curious
                     and I like to learn new technologies, frameworks,
                     libraries, etc.
                  </p>
                  <br />
                  <p>
                     My first program language was java, actually I use
